...
const sv: Record<string, string> = {
  ...
  "Guests arrive": "Gästerna anländer",
  ...
  "Shots": "Bilder",
  "Add a shot": "Lägg till en bild",
  "Untitled shot": "Namnlös bild",
  "people": "personer",
  "nobody named yet": "ingen utpekad än",
  "A picture only we would want": "En bild bara vi vill ha",
  "The picture": "Bilden",
  "Notes for the photographer": "Noteringar till fotografen",
  "Who stands in it": "Vilka som står med",
  "Add guests and you can name them here.": "Lägg till gäster så kan du peka ut dem här.",
  "Add your first shot to start the list.": "Lägg till din första bild för att börja listan.",
  "Shot list": "Bildlista",
  "Print the shot list": "Skriv ut bildlistan",
  "The couple, portraits": "Brudparet, porträtt",
  "The rings, close up": "Ringarna, närbild",
  "Everyone, one big group": "Alla, en stor grupp",
  "Bride with her family": "Bruden med sin familj",
  "Groom with his family": "Brudgummen med sin familj",
  "Both families together": "Båda familjerna tillsammans",
  "Bride with her parents": "Bruden med sina föräldrar",
  "Groom with his parents": "Brudgummen med sina föräldrar",
  "With the grandparents": "Med morföräldrar och farföräldrar",
  "With the siblings": "Med syskonen",
  "The bridal party": "Tärnor och marskalkar",
  "Bride with the bridesmaids": "Bruden med tärnorna",
  "Groom with the groomsmen": "Brudgummen med marskalkarna",
  "With the children": "Med barnen",
  "With the officiant": "Med vigselförrättaren",
  "Speeches, from the side": "Talen, från sidan",
  "The first dance": "Första dansen",
  "The room before anyone sits down": "Rummet innan någon satt sig",
  "Your playlist": "Din spellista",
  "Paste a Spotify or Apple Music link": "Klistra in en Spotify- eller Apple Music-länk",
  "Open the playlist": "Öppna spellistan",
  "Shopping list": "Inköpslista",
  "What to buy": "Vad som ska köpas",
  "Add guests and tables and the counts appear here.": "Lägg till gäster och bord så räknas antalen ut här.",
  "Paper": "Papper",
  "Keepsakes": "Minnen",
  "Menu cards": "Menykort",
  "Table numbers": "Bordsnummer",
  "Table plan board": "Bordsplaceringstavla",
  "Taper candles": "Kronljus",
  "Candle holders": "Ljusstakar",
  "Centrepiece vessels": "Vaser till borden",
  "Napkins": "Servetter",
  "Favours": "Gåvor till gästerna",
  "Aisle candles or lanterns": "Ljus eller lyktor i mittgången",
  "Ring box": "Ringask",
  "Confetti cones": "Konfettistrutar",
  "Guest book and pens": "Gästbok och pennor",
  "Cake knife and server": "Tårtkniv och spade",
  "Thank-you cards": "Tackkort",
  "one per guest": "ett per gäst",
  "one per table": "ett per bord",
  "three per table": "tre per bord",
  "one per seated guest": "ett per placerad gäst",
  "one for the entrance": "en till entrén",
  "for the aisle": "till mittgången",
  "one": "en",
  "Print them from the Print page.": "Skriv ut dem från Utskrift-sidan.",
  "One per cover, or one per two if you prefer.": "Ett per kuvert, eller ett per två om du vill.",
  "A3 or larger so it reads from a distance.": "A3 eller större så den syns på avstånd.",
  "Buy spares — they burn down over a long dinner.": "Köp extra — de brinner ner under en lång middag.",
  "Count the pew ends you want lit.": "Räkna de bänkgavlar du vill ha upplysta.",
  "Check the venue allows it, and what kind.": "Kolla att lokalen tillåter det, och vilken sort.",
  "For afterwards — the addresses are in your guest list.": "Till efteråt — adresserna finns i gästlistan.",
  "Print": "Utskrift",
  "The paper your guests will hold.": "Pappret dina gäster håller i handen.",
  "Write the menu": "Skriv menyn",
  "Sheet": "Ark",
  "Place cards": "Placeringskort",
  "Table plan": "Bordsplacering",
  "Order of service": "Program",
  "Print this sheet": "Skriv ut det här arket",
  "Add guests to print place cards.": "Lägg till gäster för att skriva ut placeringskort.",
  "Add dinner tables to print a table plan.": "Lägg till bord för att skriva ut en bordsplacering.",
  "Build your timeline to print an order of service.": "Bygg din tidslinje för att skriva ut ett program.",
  "Please find your seat": "Hitta din plats",
  "No one seated yet": "Ingen placerad än",
  "Alternative to be confirmed": "Alternativ bekräftas senare",
  "Add a moment": "Lägg till ett moment",
  "Lay out the whole day": "Lägg ut hela dagen",
  ...
  "Your timeline is empty — build the day first and this brief fills itself in.": "Din tidslinje är tom — bygg dagen först, så fyller det här brevet i sig själv.",
  "No moments in your timeline belong to this brief yet.": "Inga moment i din tidslinje hör till det här brevet än.",
  "Plays at": "Spelas vid",
  "Not tied to a moment yet": "Inte kopplad till ett moment än",
  ...
  "The room": "Rummet",
  "Floor plan of the ceremony, altar at the top": "Planritning över vigseln, altaret uppåt",
  "Doors": "Dörrar",
  "{count} see the bride's face": "{count} ser brudens ansikte",
  "{count} see the groom's face": "{count} ser brudgummens ansikte",
  "{count} see both in profile": "{count} ser båda i profil",
  "Aisle {aisle} m · back row {back} m from the altar": "Mittgång {aisle} m · bakre raden {back} m från altaret",
  ...
  "Readings": "Läsningar",
  "Vows": "Löftena",
  "Exchange of rings": "Ringväxling",
  "Group photographs": "Gruppfoton",
  "Welcome drinks": "Välkomstdrink",
  "Guests take their seats": "Gästerna sätter sig",
  "Starter served": "Förrätt serveras",
  "Main course served": "Varmrätt serveras",
  "Cutting the cake": "Tårtan skärs upp",
  "Dessert served": "Dessert serveras",
  "Dancing": "Dans",
  "Late-night food": "Nattmat",
  "Send-off": "Avfärd",
  "What everyone will remember eating.": "Det alla kommer minnas att de åt.",
  "Print the menu": "Skriv ut menyn",
  "Courses": "Rätter",
  "Add a course": "Lägg till en rätt",
  "Untitled course": "Namnlös rätt",
  "Course": "Rätt",
  "Dish": "Maträtt",
  "How it reads on the card": "Så står det på kortet",
  "Served with": "Serveras med",
  "Alternative": "Alternativ",
  "Clashes with": "Krockar med",
  "No allergies recorded on your guest list yet.": "Inga allergier registrerade på gästlistan än.",
  "guests need the alternative": "gäster behöver alternativet",
  "No alternative named yet for these guests.": "Inget alternativ angivet för de gästerna än.",
  "Add your first course to start the menu.": "Lägg till din första rätt för att börja menyn.",
  "Menu card": "Menykort",
  "Print menu cards": "Skriv ut menykort",
  "To be confirmed": "Bekräftas senare",
  "Canapés": "Snittar",
  "Starter": "Förrätt",
  "Late night": "Nattmat",
  "Drinks": "Dryck",
  ...
  "Walks the aisle": "Går längs mittgången",
  "Waits at the altar": "Väntar vid altaret",
  "Singer": "Sångare",
  "In the room": "På plats",
  "Not booked": "Inte bokad",
  "Kept automatically": "Sparas automatiskt",
  "How your plan looked on {date}": "Så såg din plan ut {date}",
  "{guests} guests · {moments} moments": "{guests} gäster · {moments} moment",
  ...
  "Build your timeline first and this becomes the running order for whoever holds the room.":
    "Bygg tidslinjen först, så blir det här körschemat för den som håller i rummet.",
  "Your timeline is empty.": "Din tidslinje är tom.",
  "Lay out the day and every moment shows up here in order.":
    "Lägg upp dagen, så visas varje moment här i ordning.",
  "{settled} of {total} moments settled": "{settled} av {total} moment avklarade",
  "Happening now": "Händer nu",
  "Up next": "Härnäst",
  "Nothing after this one.": "Inget efter det här.",
  "Marked done": "Markerat som klart",
  "Struck from the day": "Struket ur dagen",
  "Mark this moment": "Markera det här momentet",
  "Strike it": "Stryk det",
  "Put it back": "Lägg tillbaka",
  "Move through the day": "Rör dig genom dagen",
  "{position} of {total}": "{position} av {total}",
  "Back to now": "Tillbaka till nu",
  "Mark {title}": "Markera {title}",
  "Mark as done": "Markera som klar",
  "Mark as not done yet": "Markera som inte klar än",
  "Strike this moment from the day": "Stryk det här momentet från dagen",
  "Put this moment back": "Lägg tillbaka momentet",
  "cut from the day": "struket ur dagen",
  "Allergies, comma separated": "Allergier, separerade med komma",
  "Step-free seat, hearing loop…": "Trappfri plats, hörselslinga…",
  "Keep apart from…": "Håll isär från…",
  "Take a photo": "Ta ett foto",
  "Cancel": "Avbryt",
  "Preparing the light…": "Förbereder ljuset…",
  "Developing… {percent}%": "Framkallar… {percent}%",
  "Photo ready": "Fotot är klart",
  "Download photo": "Ladda ner foto",
  "Back to editing": "Tillbaka till redigering",
  "The photo could not be created on this device.": "Fotot kunde inte skapas på den här enheten.",
  "Keep {name} apart from another guest": "Håll {name} isär från en annan gäst",
  "Stop keeping {name} and {other} apart": "Sluta hålla {name} och {other} isär",
  "Allergies for {name}": "Allergier för {name}",
  "Accessibility notes for {name}": "Tillgänglighetsnoteringar för {name}",
  "Enters with the procession.": "Går in med processionen.",
  "Already on the mark when the bride walks in.": "Står redan på sin plats när bruden går in.",
  "Move where everyone stands": "Flytta var alla står",
  "Reset staging": "Återställ scenografin",
  "Drag the markers in the plan to move anyone.": "Dra markörerna i planen för att flytta någon.",
  "Altar flowers": "Altarblommor",
  "Restart": "Börja om",
  ...
  "Seating": "Placering",
  "Ceremony Setup": "Ceremoniupplägg",
  "aisle": "mittgång",
  // Home 3D studio workspace
  "Previewing your day": "Förhandsvisar er dag",
  "Mode": "Läge",
  "Preview": "Förhandsvisa",
  "Exit preview": "Avsluta förhandsvisningen",
  "More options": "Fler alternativ",
  "Shareable link": "Delningsbar länk",
  "Scene tools": "Scenverktyg",
  "3D venue workspace": "3D-lokalen",
  "Camera controls": "Kamerakontroller",
  "Hide panel": "Dölj panelen",
  "Show panel": "Visa panelen",
  "Scene inspector": "Scenpanel",
  "Selected": "Vald",
  "All clear": "Allt klart",
  "{count} to review": "{count} att se över",
  "Scene overview": "Scenöversikt",
  "Objects": "Objekt",
  "Lighting": "Ljussättning",
  "Scene objects": "Scenens objekt",
  "Nudge the selected object, or drag it directly in the scene.": "Knuffa det valda objektet, eller dra det direkt i scenen.",
  "Nudge {object}": "Knuffa {object}",
  "Nudge away from camera": "Knuffa bort från kameran",
  "Nudge toward camera": "Knuffa mot kameran",
  "Nudge left": "Knuffa åt vänster",
  "Nudge right": "Knuffa åt höger",
  "Reset position": "Återställ positionen",
  "Offset": "Förskjutning",
  "In preview, light follows the time of day automatically.": "I förhandsvisningen följer ljuset automatiskt tiden på dagen.",
  "Scene check": "Scenkoll",
  "All clear — nothing needs attention in this scene.": "Allt klart — inget behöver åtgärdas i den här scenen.",
  "Quick actions": "Snabbval",
  "Edit seating": "Justera placeringen",
  "Adjust lighting": "Justera ljuset",
  "Open the timeline": "Öppna tidslinjen",
  "Seats": "Platser",
  "Reception begins": "Mottagningen börjar",
  "{seated} of {invited} guests have a seat": "{seated} av {invited} gäster har en plats",
  "{seats} seats across {tables} tables": "{seats} platser vid {tables} bord",
  "{count} guests over comfortable capacity": "{count} gäster över bekväm kapacitet",
  "{count} guests don't have a seat yet": "{count} gäster saknar plats än",
  "Review guest list": "Se över gästlistan",
  "Fine-tune the timing": "Finjustera tajmingen",
  "Balanced layout": "Balanserad plan",
  "Full ceremony": "Fullsatt vigsel",
  "Intimate ceremony": "Intim vigsel",
  "Dinner tables": "Middagsbord",
  ...
  "Next moment": "Nästa moment",
  "Moment {current} of {total}": "Moment {current} av {total}",
  ...
  "The app is running locally — everything saves to this browser. To add an account (cloud backup is coming soon), connect a free Supabase project.": "Appen körs lokalt — allt sparas i den här webbläsaren. Anslut ett gratis Supabase-projekt för att lägga till ett konto (molnbackup kommer snart).",
  ...
  "Household": "Hushåll",
  "Household / +1 group": "Hushåll / +1",
  "{count} guests haven't responded yet.": "{count} gäster har inte svarat än.",
  "Show pending": "Visa väntande",
  "Quote": "Offert",
  ...
  "Add both of your names before creating the plan.": "Lägg till era båda namn innan ni skapar planen.",
  "Add your wedding date before creating the plan.": "Lägg till ert bröllopsdatum innan ni skapar planen.",
  "First name": "Förnamn",
  ...
  "Remove speech": "Ta bort tal",
  "Add table": "Lägg till bord",
  "Remove table": "Ta bort bord",
  "Table name": "Bordsnamn",
  ...
  "Everything you enter is saved in this browser. Download a backup file to keep it safe, or move your plan to another device.": "Allt du skriver in sparas i den här webbläsaren. Ladda ner en säkerhetskopia för att spara den tryggt, eller flytta din plan till en annan enhet.",
  "Download backup": "Ladda ner säkerhetskopia",
  "Restore from backup": "Återställ från säkerhetskopia",
  "Backup downloaded — keep it somewhere safe.": "Säkerhetskopia nedladdad — spara den på ett säkert ställe.",
  "Backup restored — reloading your plan…": "Säkerhetskopia återställd — laddar om din plan…",
  "Couldn't read that file.": "Kunde inte läsa den filen.",
  "That file isn't a Wedding Flow Studio backup.": "Den filen är inte en säkerhetskopia från Wedding Flow Studio.",
  ...
  "A wedding preview": "En bröllopsförhandsvisning",
  "Run of show": "Körschema",
  "Opening the plan…": "Öppnar planen…",
  "This link has no plan to show.": "Den här länken har ingen plan att visa.",
  "Ask for a fresh link, or start your own wedding preview.": "Be om en ny länk, eller skapa din egen bröllopsförhandsvisning.",
  "Open Wedding Flow Studio": "Öppna Wedding Flow Studio",
  "Wedding facts": "Bröllopsfakta",
  "Previewed with Wedding Flow Studio": "Förhandsvisat med Wedding Flow Studio",
  "Plan your own": "Planera ditt eget",
  "Unified Studio Workspace": "Samlad studioyta",
  "Selected moment status": "Status för valt ögonblick",
  "Focused wedding day scene": "Fokuserad bröllopsdagsscen",
  "Team": "Team",
  "Moment brief": "Ögonblicksbrief",
  "Wedding day moments": "Bröllopsdagens ögonblick",
  "Work on {title}": "Arbeta med {title}",
  "Studio details": "Studiodetaljer",
  "Vendor gaps, saved candidates, and local updates.": "Leverantörsluckor, sparade kandidater och lokala uppdateringar.",
  "Vendor Intelligence": "Leverantörsintelligens",
  "All required vendor decisions are moving.": "Alla nödvändiga leverantörsbeslut rör på sig.",
  "{candidates} saved candidates · {booked} booked · {gaps} required gaps":
    "{candidates} sparade kandidater · {booked} bokade · {gaps} nödvändiga luckor",
  "Open Production Sourcing": "Öppna produktionssökning",
  "Studio update": "Studiouppdatering",
  "Impact layers": "Påverkanslager",
  "Role, brief, guest, cue, and graph context for this moment.": "Roll-, brief-, gäst-, cue- och grafkontext för detta ögonblick.",
  "Affected roles": "Berörda roller",
  "Affected briefs": "Berörda briefer",
  "Missing signals": "Saknade signaler",
  "Current health": "Nuvarande status",
  "{count} moments need review": "{count} ögonblick behöver granskas",
  "{count} moments are blocked": "{count} ögonblick är blockerade",
  "{count} open production risks": "{count} öppna produktionsrisker",
  "Guest journey": "Gästresa",
  "Production graph": "Produktionsgraf",
  "{count} connected nodes": "{count} anslutna noder",
  "{count} connected edges": "{count} anslutna kopplingar",
  "One Decision Panel": "Ett-beslut-panel",
  "Next Best Move": "Nästa bästa drag",
  "Recommended action": "Rekommenderad åtgärd",
  "Decision reasoning": "Beslutsunderlag",
  "Confidence, impact, and rehearsal context.": "Säkerhet, påverkan och repetitionskontext.",
  "Confidence": "Säkerhet",
  "Decision confidence": "Beslutssäkerhet",
  "What matters now": "Vad som är viktigt nu",
  "What will change": "Vad som förändras",
  "Rehearsal signal": "Repetitionssignal",
  "{title}: {score}% day-feel score.": "{title}: {score}% dagskänsla.",
  ...
  "Cinematic preview of your wedding day": "Filmisk förhandsvisning av er bröllopsdag",
  "Cinematic preview": "Filmisk förhandsvisning",
  "Venue Preview": "Förhandsvisning av lokal",
  ...
  "Prepared by": "Sammanställt av",
  "Keep your plan safe.": "Håll er plan trygg.",
  "Who does what": "Vem gör vad",
  "Everyone's part in the day.": "Allas roll under dagen.",
  "Set your budget to track over/under.": "Ange er budget för att följa över/under.",
  "Production note": "Produktionsnotis",
  "Only the details connected to this handoff.": "Endast detaljerna som hör till den här överlämningen.",
  ...
  // Intake — questions
  "Start with 3 questions": "Börja med 3 frågor",
  ...
  "Add a photo of each of you?": "Vill ni lägga till ett foto på er var?",
  "Optional — your faces appear on the couple in the 3D church.": "Valfritt — era ansikten hamnar på brudparet i 3D-kyrkan.",
  "Your own faces on the couple at the altar.": "Era egna ansikten på paret vid altaret.",
  // Intake — chrome
  ...
  "Three question progress": "Förlopp för tre frågor",
  "Answered": "Besvarad",
  "Now": "Nu",
  "Next": "Nästa",
  ...
  "Format, style, venues and who is involved — all have sensible defaults.": "Format, stil, lokaler och vilka som är med — allt har rimliga standardval.",
