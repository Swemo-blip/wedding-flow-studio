...
const sv: Record<string, string> = {
  ...
  "Your faces in 3D": "Era ansikten i 3D",
  "Your faces in the 3D preview": "Era ansikten i 3D-förhandsvisningen",
  "Upload a photo of each of you — it appears on the couple walking down the aisle in the 3D ceremony.": "Ladda upp ett foto på var och en av er — det visas på paret som går längs gången i 3D-vigseln.",
